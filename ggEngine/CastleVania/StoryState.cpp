...
{
	this->cvPreload->Texture(TextureConstant::SIMON_TEXTURE, TextureConstant::SIMON_TEXTURE_PATH);
...
void StoryState::Create()
{
	...
	this->bg = this->cvAdd->Sprite(128, 133, TextureConstant::INTRO_BG_TEXTURE, group);
	this->bg->SetAnchor(0.5, 0.5);

	this->helicopter = this->cvAdd->Sprite(73, 133, TextureConstant::HELICOPTER_TEXTURE, group);
	this->helicopter->SetAnchor(0.5, 0.5);

	this->bat1 = this->cvAdd->SpriteAnimation(128, 132, TextureConstant::BAT_ANIM_TEXTURE, 17, 16, group, 0, 2, 300);
	this->bat1->SetAnchor(0.5, 0.5);
	this->bat1->CreateAnimation("bat1", 0, 1, true);
	this->bat1->PlayAnimation("bat1");

	this->bat2 = this->cvAdd->SpriteAnimation(128, 132, TextureConstant::BAT_ANIM_TEXTURE, 17, 16, group, 0, 2, 300);
	this->bat2->SetAnchor(0.5, 0.5);
	this->bat2->CreateAnimation("bat2", 0, 1, true);
	this->bat2->PlayAnimation("bat2");

	this->simon = this->cvAdd->SpriteAnimation(224, 182, TextureConstant::SIMON_TEXTURE, 45, 40, group, 0, 25, 200);
	...
	this->cvAdd->LoopInfinity(0, [this] {
