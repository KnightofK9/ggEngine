...
namespace ggEngine{
	...
	ggEngine::TweenBase * Add::Tween(float & val, double end, double duration, std::function<double(int,double,double,int)> easingFunction, bool isAddToTweenManager)
	{
	...
	ggEngine::TweenBase * Add::Tween(double init, double end, double duration, std::function<double(int, double, double, int)> easingFunction,  std::function<void(double)> update, bool isAddToTweenManager)
	{
		ggEngine::Tween* tween = new ggEngine::Tween(this->tweenManager, init, end, duration, update, easingFunction);
		if (isAddToTweenManager)this->tweenManager->AddTween(tween);
		return tween;
	}
	ggEngine::MultiTween * Add::MultiTween(std::list<TweenBase*> tweenList, bool isAddToTweenManager)
	{
